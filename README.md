...
2. Update the system prompt to guide your agent correctly
3. Ensure the agent outputs `<promise>COMPLETE</promise>` when finished
4. Test with a small number of iterations first

### PRD Best Practices

- **Be specific**: "Add authentication" vs "Implement OAuth2 with Google and GitHub"
